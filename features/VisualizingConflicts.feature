...
Scenario: See Conflicts for a Simple Schedule
  Then I should see the following conflicts in a table
  | <Dance Name>    | <Dancer Name 1> | <Dancer Name 2> |
  | <Dance Name>    | <Dancer Name 3> |
  | <Dance Name>    | <Dancer Name 4> | <Dancer Name 5> |